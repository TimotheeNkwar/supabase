...
(() => {
  ...
  class ArticleManager {
    ...
    openEditModal(article = {}) {
      ...
      this.fieldCategory.value = article.category || 'technology, supply-chain,tutorials, analysis, career,methodology';
    ...
    async handleFormSubmit() {
      ...
      const payload = {
        ...
        category: this.fieldCategory.value?.trim() || 'technology, supply-chain,tutorials, analysis, career,methodology',
